...
import deedeveloper.examples.va_classifier.ECGAnalysis.classification.Classifier.ClassifyResult;
...
public class BeatDetectionAndClassification 
{
    ...
    public BeatDetectAndClassifyResult BeatDetectAndClassify(int ecgSample)
    {
        ...
        if(domType == -1)
        {
            beatBegin = qrsDetParas.MS250 ;  //50.5sample (200samples/s)
            beatEnd = qrsDetParas.MS300 ;   //60.5sample(200samples/s)
        }
        else
        {
