...
public class  BDACParameters{
    ...
    {
        BEAT_SAMPLE_RATE   = beatSampleRate ;  //100 sample for one beat
        BEAT_MS_PER_SAMPLE = ( (double) 1000/ (double) BEAT_SAMPLE_RATE) ; //1000ms/100sample = 10 ms/beat samples
        ...
        BEATLGTH           = BEAT_MS1000 ; // 100 beat sample 
        MAXTYPES           = 8 ;
        FIDMARK            = BEAT_MS400 ;  //40.5 beat sample
    }
