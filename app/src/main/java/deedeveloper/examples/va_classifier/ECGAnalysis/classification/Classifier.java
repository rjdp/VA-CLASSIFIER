package deedeveloper.examples.va_classifier.ECGAnalysis.classification;

import deedeveloper.examples.va_classifier.ECGAnalysis.classification.BeatAnalyzer.AnalyzeBeatResult;
import deedeveloper.examples.va_classifier.ECGAnalysis.classification.Matcher.BestMorphMatchResult;
import deedeveloper.examples.va_classifier.ECGAnalysis.detection.QRSDetectorParameters;

import static deedeveloper.examples.va_classifier.ECGAnalysis.classification.ECGCODES.NORMAL;
import static deedeveloper.examples.va_classifier.ECGAnalysis.classification.ECGCODES.PVC;
import static deedeveloper.examples.va_classifier.ECGAnalysis.classification.ECGCODES.UNKNOWN;
